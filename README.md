...
Bu proje, Fırat Üniversitesi Teknoloji Fakültesi Yazılım Mühendisliği Bölümü bünyesinde, "YMH212 - Yazılım Gereksinimleri ve Analizi" dersi kapsamında geliştirilmiş web tabanlı bir online randevu sistemi projesidir.

## 🎯 Projenin Amacı

Projenin temel amacı; berber, psikolog, özel ders öğretmeni veya pansiyon işletmecisi gibi randevu ile çalışan hizmet sağlayıcıları ile bu hizmetlerden faydalanmak isteyen kullanıcıları tek bir dijital platformda buluşturmaktır.

Sistem, randevu sürecindeki iletişim problemlerini, zamanlama çakışmalarını ve yönetim zorluklarını ortadan kaldırarak, hem hizmet verenler hem de hizmet alanlar için verimli, şeffaf ve kullanıcı dostu bir çözüm sunar.
